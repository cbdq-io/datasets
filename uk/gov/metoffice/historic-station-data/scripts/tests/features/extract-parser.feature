Feature: Extract Parser
  ...
  Scenario Outline: Parse Record by Line Number
    ...
    Examples:
        ...
        | camborne     | 1           | station_name | camborne |
        | camborne     | 1           | month        | None     |
        | camborne     | 6           | station_name | camborne |
        | camborne     | 7           | station_name | camborne |
  ...
  Scenario Outline: Parse Record by Month
    ...
    Examples:
        ...
        | camborne     | 1978-09 | metadata          | None                     |
